...
//           if (options.css3) {
//             var translate3d =
//               "translate3d(0px, -" + element.position().top + "px, 0px)";
//             transformContainer(translate3d, false);
//           } else {
//             //deleting the possible negative top
//             $("#superContainer").css(
//               "top",
//               "-" + element.position().top + "px"
//             );
//           }
//         }
//       } else {
...
//           $(this).css(
//             "padding",
//             options.paddingTop + " 0 " + options.paddingBottom + " 0"
//           );
//         }
...
//             .find(".slides")
//             .after(
//               '<div class="controlArrow prev"></div><div class="controlArrow next"></div>'
//             );
//           $(this)
//             .find(".controlArrow.next")
//             .css(
//               "border-color",
//               "transparent transparent transparent " + options.controlArrowColor
//             );
//           $(this)
//             .find(".controlArrow.prev")
//             .css(
//               "border-color",
//               "transparent " +
...
//               this,
//               anchorLink,
//               currentSection.index(".section") + 1
//             );
...
//           if (
//             activeSection.find(".slides").length &&
//             Math.abs(touchStartX - touchEndX) >
//               Math.abs(touchStartY - touchEndY) + xThreshold
//           ) {
...
//         $.isFunction(options.onLeave) &&
//           options.onLeave.call(this, leavingSection, yMovement);
...
//         setTimeout(function () {
//           $.isFunction(options.afterLoad) &&
//             options.afterLoad.call(this, anchorLink, sectionIndex + 1);
...
//         if (
//           (section && section !== lastScrolledDestiny) ||
//           (typeof slide != "undefined" && !slideMoving)
//         ) {
//           scrollPageAndSlide(section, slide);
//         }
//       }
...
//       } else if (type === "bottom") {
//         return (
//           scrollable.scrollTop() + scrollable.innerHeight() >=
...
//         var contentHeight =
//           element.find(".scrollable").get(0).scrollHeight -
...
//         .addClass("table")
//         .wrapInner(
//           '<div class="tableCell" style="height:' + windowsHeight + 'px;" />'
//         );
//     }
